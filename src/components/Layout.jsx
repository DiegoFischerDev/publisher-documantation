  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-grow basis-0 items-center">
        <Link href="/" className='flex justify-center sm:justify-start w-full'>
          <div className="flex cursor-pointer items-center text-xl font-bold">
            <Image
              ...
              unoptimized
            />
            <p className="ml-1 text-base sm:text-lg">Publisher Analytics Docs</p>
          </div>
        </Link>
      </div>
      <div className="">
      ...
      <div className="relative flex basis-0 justify-end gap-6 ml-3 sm:ml-8 sm:gap-8">
